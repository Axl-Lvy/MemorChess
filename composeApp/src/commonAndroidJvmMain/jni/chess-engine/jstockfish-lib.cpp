...
bool initJvm(JavaVM *vm) {
  ...
  uciClass = env->FindClass("proj/memorchess/axl/core/stockfish/UCI");
	if (!uciClass) {
...
Java_proj_memorchess_axl_core_stockfish_UCI_00024Companion_uci(JNIEnv *env, jobject thiz) {
  stringstream uci;
...
Java_proj_memorchess_axl_core_stockfish_UCI_00024Companion_setOption(JNIEnv *env, jobject thiz,
...
Java_proj_memorchess_axl_core_stockfish_UCI_00024Companion_newGame(JNIEnv *env, jobject thiz) {
  Search::clear();
  Tablebases::init(Options["SyzygyPath"]);
...
extern "C"
JNIEXPORT jboolean JNICALL
Java_proj_memorchess_axl_core_stockfish_UCI_00024Companion_position(JNIEnv *env, jobject thiz,
                                                                    jstring position) {
...
extern "C"
JNIEXPORT void JNICALL
Java_proj_memorchess_axl_core_stockfish_UCI_00024Companion_go(JNIEnv *env, jobject thiz,
                                                              jstring options) {
...
extern "C"
JNIEXPORT void JNICALL
Java_proj_memorchess_axl_core_stockfish_UCI_00024Companion_stop(JNIEnv *env, jobject thiz) {
  Threads.stop = true;
}

extern "C"
JNIEXPORT void JNICALL
Java_proj_memorchess_axl_core_stockfish_UCI_00024Companion_ponderHit(JNIEnv *env, jobject thiz) {
...
extern "C"
JNIEXPORT jstring JNICALL
Java_proj_memorchess_axl_core_stockfish_UCI_00024Companion_d(JNIEnv *env, jobject thiz) {
  stringstream ss;
  ss << gPos;
...
extern "C"
JNIEXPORT void JNICALL
Java_proj_memorchess_axl_core_stockfish_UCI_00024Companion_flip(JNIEnv *env, jobject thiz) {
  gPos.flip();
}

extern "C"
JNIEXPORT jstring JNICALL
Java_proj_memorchess_axl_core_stockfish_UCI_00024Companion_eval(JNIEnv *env, jobject thiz) {
    stringstream ss;
    ss << Eval::trace(gPos);
    jstring ret = env->NewStringUTF(ss.str().c_str());
    return ret;
...
Java_proj_memorchess_axl_core_stockfish_UCI_00024Companion_whiteScores(JNIEnv *env, jobject thiz) {
...
extern "C"
JNIEXPORT jboolean JNICALL
Java_proj_memorchess_axl_core_stockfish_UCI_00024Companion_isLegal(JNIEnv *env, jobject thiz,
                                                                   jstring move) {
...
extern "C"
JNIEXPORT jstring JNICALL
Java_proj_memorchess_axl_core_stockfish_UCI_00024Companion_fen(JNIEnv *env, jobject thiz) {
  string fen = gPos.fen();
...
Java_proj_memorchess_axl_core_stockfish_UCI_00024Companion_ordinalState(JNIEnv *env, jobject thiz) {
...
extern "C"
JNIEXPORT jdoubleArray JNICALL
Java_proj_memorchess_axl_core_stockfish_Position_00024Companion_whiteScores(JNIEnv *env,
                                                                            jobject thiz,
                                                                            jboolean chess960,
                                                                            jstring position) {
...
extern "C"
JNIEXPORT jboolean JNICALL
Java_proj_memorchess_axl_core_stockfish_Position_00024Companion_isLegal(JNIEnv *env, jobject thiz,
                                                                        jboolean chess960,
                                                                        jstring position,
                                                                        jstring move) {
  StateListPtr states(new std::deque<StateInfo>(1));
...
extern "C"
JNIEXPORT jstring JNICALL
Java_proj_memorchess_axl_core_stockfish_Position_00024Companion_fen(JNIEnv *env, jobject thiz,
                                                                    jboolean chess960,
                                                                    jstring position) {
  StateListPtr states(new std::deque<StateInfo>(1));
  Position pos;
...
extern "C"
JNIEXPORT jint JNICALL
Java_proj_memorchess_axl_core_stockfish_Position_00024Companion_ordinalState(JNIEnv *env,
                                                                             jobject thiz,
                                                                             jboolean chess960,
                                                                             jstring position) {
  StateListPtr states(new std::deque<StateInfo>(1));
