...
object DateUtil {
  ...
  /**
   * Converts a [LocalDateTime] to an [Instant] using the system's default timezone.
   *
   * @return [Instant] representing this date and time in the system default timezone
   */
