...
val KineticDarkPalette =
  KineticPalette(
    ...
    accentSoft = Color(0x24FF5B26), // rgba(255, 91, 38, 0.14)
    onAccent = Color(0xFF000000),
    cyan = Color(0xFF4CD6E8),
    cyanGlow = Color(0x664CD6E8), // rgba(76, 214, 232, 0.4)
    green = Color(0xFF6EE7A4),
    greenDim = Color(0xFF2A6B3E),
    greenSoft = Color(0x1F6EE7A4), // rgba(110, 231, 164, 0.12)
    red = Color(0xFFFF4060),
    redDim = Color(0xFF6B2030),
    redSoft = Color(0x1AFF4060), // rgba(255, 64, 96, 0.1)
...
val KineticLightPalette =
  KineticPalette(
    ...
    accentSoft = Color(0x1AFF5B26), // rgba(255, 91, 38, 0.1)
    onAccent = Color(0xFFFFFFFF),
    cyan = Color(0xFF00B8D4),
    cyanGlow = Color(0x6600B8D4), // rgba(0, 184, 212, 0.4)
    green = Color(0xFF00A86B),
    greenDim = Color(0xFFB5E6D3),
    greenSoft = Color(0x1A00A86B), // rgba(0, 168, 107, 0.1)
    red = Color(0xFFE11D48),
    redDim = Color(0xFFF4C2CC),
    redSoft = Color(0x14E11D48), // rgba(225, 29, 72, 0.08)
