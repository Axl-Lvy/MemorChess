...
import proj.memorchess.axl.ui.pages.BookCreation
...
private fun NavGraphBuilder.bookCreationRoute() {
  composable<Route.BookCreationRoute> {
    val bookId = it.toRoute<Route.BookCreationRoute>().bookId
    BookCreation(bookId)
  }
}
