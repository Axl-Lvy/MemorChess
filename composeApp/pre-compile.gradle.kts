...
tasks.registering {
  ...
  val content = buildString {
    appendLine("package proj.memorchess.axl.util.generated")
    appendLine()
    appendLine("import proj.memorchess.axl.util.SecretsTemplate")
    appendLine()
    appendLine("/**")
...
fun getGeneratedFileName(projectDir: File): Pair<File, File> {
  val secretsPackageDir =
    File("$projectDir/src/commonMain/kotlin/proj/memorchess/axl/util/generated")
